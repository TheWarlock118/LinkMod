...
namespace LinkMod.Modules
{
    public static class Config
    {
        public static void ReadConfig()
        {
            ...
            Config.BombDamageCoeffConfig = LinkPlugin.instance.Config.Bind<float>("Balance", "Bomb Damage %", 550, "Default: 550%");
            Config.BombArrowDamageCoeffConfig = LinkPlugin.instance.Config.Bind<float>("Balance", "Bomb Arrow Damage %", 550, "Default: 550%");
            Config.UrbosaDamageCoeffConfig = LinkPlugin.instance.Config.Bind<float>("Balance", "Urbosa Damage %", 650, "Default: 650%");
